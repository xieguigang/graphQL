...
<Assembly: AssemblyDescription("Knowledge database model and the algorithm to handle knowledge identification.")>
...
<Assembly: Guid("0457349f-a04c-4729-9b06-b746ca91a1a1")>
